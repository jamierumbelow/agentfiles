...
- `evergreen/` — ongoing notes about live projects, topics of study, etc
- `jamierumbelow.net/` — content and drafts for Jamie's personal website (blog posts, book lists, restaurants, blogroll)
...
This contains the daily journal and worklog. Each entry is collaborative document built up over the course of the day between the agent and Jamie.
...
When adding worklog entries or todos, feel free to clean up, embellish, expand, or simplify what I say so that it reads well and is in keeping with the [[STYLEGUIDE]]. My instructions will often be brief or sloppy shorthand — use your judgement to turn them into clear, well-written entries.

### jamierumbelow.net

Jamie's personal website is built from content in this directory.